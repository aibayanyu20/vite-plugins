...
describe('types', () => {
  it('code1', () => {
    ...
    expect(code).toMatchInlineSnapshot(`
      ...
      export const Code = defineComponent<Props>({props: /*@__PURE__*/_mergeDefaults({
      ...
      export default defineComponent<Props>({props: /*@__PURE__*/_mergeDefaults({
          a: { type: String, required: false }
        }, defaultProps), 
        setup(props) {
          return () => {
  ...
  it('code2', () => {
    ...
    expect(code).toMatchInlineSnapshot(`
      ...
      export const Code = defineComponent<{ a: string } & Props >({props: /*@__PURE__*/_mergeDefaults({
...
function compiler(raw: string, id: string) {
  return runTransformFixture(raw, path.resolve(basePath, `types/${id}`), {
    emits: false,
  })
}
